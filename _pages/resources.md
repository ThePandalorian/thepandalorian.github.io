...
- ['Physics of Life' by the American National Physics Association](https://nap.nationalacademies.org/catalog/26403/physics-of-life). I very strongly disagree with the classification of most of the things covered in this piece as 'physics' (I think it is 'physics' to the exact same degree that calculus is physics) or of any of the subject matter covered as 'a field of physics', but I include this survey here nevertheless for any stray physicists that may run into my page. This article surveys how tools first created in areas of physics such as statistical mechanics have been co-opted to study biological systems across various scales of biology. While the article is written by physicists and views these biological models as 'areas of physics', I urge you to notice that using a partition function (originally from stat mech) to study ensembles of species in an ecological community is physics to the same degree that using calculus (originally from Newtonian mechanics) to model Lotka-Volterra communities is physics: it's all just mathematics, physics isn't special :)
...
- [Dawson 2017 - Introductory Lectures on Stochastic Population Systems](https://arxiv.org/abs/1705.03781). 'Introductory' here is meant to mean that the target audience is someone who does not know anything about biology - the text assumes quite a bit of background in stochastic analysis. If you are a biologist who is new to mathematics, this text is not meant for you, it assumes a lot of mathematical background and is written in the typical definition-theorem-proof style that mathematicians love. I am including this reference just to convince any wandering mathematicians that the study of stochastic models in population biology is quite mathematically intricate --- if lecture notes by Don Dawson (of Dawson-Watanabe superprocess fame) himself cannot convince you of this, I have no hope :)
- [Etheridge 2011 - Some Mathematical Models from Population Genetics](https://link.springer.com/book/10.1007/978-3-642-16632-7). Much like the notes by Dawson, this is a textbook on population genetics aimed at mathematicians who are familiar with analysis but unfamiliar with biological language and concepts.
