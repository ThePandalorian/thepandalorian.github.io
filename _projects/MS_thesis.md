...
img: assets/img/noise_induced_selection.png
importance: 1
category: Previous
...
<div class="row" style="text-align: center">
    <div class="col-sm mt-3 mt-md-0">
        <img src="{{ 'assets/img/evolutionary_branching.png' | relative_url }}" class="img-fluid rounded z-depth-1" alt="Evolutionary branching">
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center"  style="text-align: center">
    <div class="col-sm mt-3 mt-md-0">
		<img src="{{ 'assets/img/discrete_vs_quant_trait_comparison.png' | relative_url }}" class="img-fluid rounded z-depth-1">
    </div>
</div>
<div class="caption">
